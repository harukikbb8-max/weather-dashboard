...
const CONDITION_PALETTES: Record<SkyCondition, PaletteEntry[]> = {
  ...
  /* ── 曇り(50-80%): 灰色がかった重い夜空。星は見えない ── */
  cloudy: [
    { phase: 0.00, colors: ["#2a2e38", "#383e48", "#353a42", "#303540"] },
    { phase: 0.15, colors: ["#333840", "#404650", "#3e4550", "#383e48"] },
    { phase: 0.25, colors: ["#3e4350", "#505560", "#585e65", "#606468"] },
    { phase: 0.33, colors: ["#454a55", "#585e68", "#706058", "#a07050"] },
  ...
  /* ── どんより(80%+): 厚い雲で覆われた灰色の夜空。街明かりが雲に反射 ── */
  overcast: [
    { phase: 0.00, colors: ["#3a3e45", "#484e55", "#454a50", "#404548"] },
    { phase: 0.15, colors: ["#454a50", "#555a62", "#505860", "#4a5058"] },
    { phase: 0.25, colors: ["#505560", "#626870", "#6a7078", "#727880"] },
    { phase: 0.33, colors: ["#5a6068", "#6e7580", "#787e85", "#858b92"] },
    { phase: 0.42, colors: ["#606870", "#758088", "#858d95", "#959da5"] },
    { phase: 0.55, colors: ["#6a7585", "#808a98", "#95a0ab", "#a8b2bc"] },
    { phase: 1.00, colors: ["#6a7585", "#808a98", "#95a0ab", "#a8b2bc"] },
  ],
  /* ── 雨: 暗く青緑がかった重い夜空 ── */
  rain: [
