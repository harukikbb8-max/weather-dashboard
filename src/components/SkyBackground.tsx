...
const CONDITION_PALETTES: Record<SkyCondition, PaletteEntry[]> = {
  ...
  /* ── 曇り(50-80%) ── */
  cloudy: [
    { phase: 0.00, colors: ["#505560", "#606870", "#5a6068", "#555c65"] },
    { phase: 0.15, colors: ["#586068", "#687078", "#626a72", "#5e666e"] },
    { phase: 0.25, colors: ["#636a75", "#737a85", "#6e7680", "#6a7078"] },
    { phase: 0.33, colors: ["#6e7580", "#7e8688", "#786858", "#a08060"] },
  ...
  /* ── どんより(80%+): 鉛色 ── */
  overcast: [
    { phase: 0.00, colors: ["#687078", "#788088", "#727a82", "#6a7280"] },
    { phase: 0.15, colors: ["#727a85", "#828a92", "#7c848c", "#757d88"] },
    { phase: 0.25, colors: ["#7e8690", "#8e969e", "#889098", "#828a92"] },
