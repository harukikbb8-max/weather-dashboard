...
const CONDITION_PALETTES: Record<SkyCondition, PaletteEntry[]> = {
  ...
  /* ── 曇り: 青みが薄れ灰がかった夜空 ── */
  cloudy: [
    { phase: 0.00, colors: ["#1a2030", "#283048", "#253040", "#202838"] },
    { phase: 0.15, colors: ["#222840", "#303850", "#354058", "#2e3848"] },
    { phase: 0.25, colors: ["#2e3345", "#404555", "#505560", "#5a5050"] },
    { phase: 0.33, colors: ["#353848", "#505560", "#706058", "#a07050"] },
  ...
  /* ── どんより: 明るめの灰色。雲で空が覆われた重い印象 ── */
  overcast: [
    { phase: 0.00, colors: ["#252830", "#303540", "#2e3238", "#282c32"] },
    { phase: 0.15, colors: ["#303540", "#3a4048", "#3e4248", "#383c42"] },
    { phase: 0.25, colors: ["#3a3e48", "#484d58", "#525860", "#5a6068"] },
    { phase: 0.33, colors: ["#454a55", "#585e68", "#656b72", "#757b82"] },
    { phase: 0.42, colors: ["#505868", "#657078", "#758088", "#8890a0"] },
