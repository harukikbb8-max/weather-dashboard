...
const CONDITION_PALETTES: Record<SkyCondition, PaletteEntry[]> = {
  ...
  /* ── 曇り(50-80%): はっきり灰色の夜空 ── */
  cloudy: [
    { phase: 0.00, colors: ["#404550", "#505862", "#4a5058", "#454b55"] },
    { phase: 0.15, colors: ["#4a5058", "#5a6270", "#556068", "#505860"] },
    { phase: 0.25, colors: ["#555c65", "#687078", "#707880", "#788088"] },
    { phase: 0.33, colors: ["#606870", "#737a82", "#807068", "#a88060"] },
    { phase: 0.42, colors: ["#506070", "#688098", "#988870", "#b89060"] },
    { phase: 0.55, colors: ["#4a7ab5", "#6a95c8", "#8cb0d8", "#b8cfe5"] },
    { phase: 1.00, colors: ["#4a7ab5", "#6a95c8", "#8cb0d8", "#b8cfe5"] },
  ],
  /* ── どんより(80%+): 完全に灰色。分厚い雲に覆われた鉛色の空 ── */
  overcast: [
    { phase: 0.00, colors: ["#585e65", "#6a7078", "#626870", "#5a6068"] },
    { phase: 0.15, colors: ["#636a72", "#757c85", "#6e7880", "#687078"] },
    { phase: 0.25, colors: ["#6e7580", "#808890", "#7a8288", "#747c85"] },
    { phase: 0.33, colors: ["#788088", "#8a9298", "#929aa0", "#9aa2a8"] },
    { phase: 0.42, colors: ["#808890", "#929aa2", "#9aa2aa", "#a5adb5"] },
    { phase: 0.55, colors: ["#8590a0", "#98a2b0", "#a5b0ba", "#b5bfc8"] },
    { phase: 1.00, colors: ["#8590a0", "#98a2b0", "#a5b0ba", "#b5bfc8"] },
  ],
  /* ── 雨: 暗く青緑がかった重い夜空 ── */
  rain: [
