...
export default function Home() {
  ...
  return (
    <>
      ...
      <SkyBackground weatherCode={currentWeather?.weather_code} hoveredPoint={hoveredPoint} precipitation={currentWeather?.precipitation} cloudCover={currentWeather?.cloud_cover} latitude={city.latitude} />
